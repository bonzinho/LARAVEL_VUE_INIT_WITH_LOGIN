...
Route::group(['middleware' => 'cors', 'as' => 'api.'], function(){
    ...
    Route::group(['middleware' => 'auth:api'], function(){
        ...
        route::get('/user', function(Request $request){
            $user = Auth::guard('api')->user(); // com o auth  posso pegar o usuario ondequiser enquanto a requisição esta mais virada para o controller
            //$user = $request->user('api'); // usado mais no controler
            return $user;
        })->name('user');
    });
