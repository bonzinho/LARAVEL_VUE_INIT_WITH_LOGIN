...
/***/ (function(module, exports, __webpack_require__) {
	...
	Vue.http.options.root = "http://localhost:8000/api"; // base da requisição
...
/***/ (function(module, exports) {
	...
	module.exports = "\n<div id=\"app\">\n    <header>\n\n    </header>\n\n    <main>\n        <router-view></router-view>\n    </main>\n\n    <footer class=\"page-footer\">\n        <div class=\"footer-copyright\">\n            <div class=\"container\">\n                {{ year }} Candidaturas Brasil - Mestrados Integrados\n            </div>\n        </div>\n    </footer>\n\n</div>\n";
	            ...
	            _auth2.default.login(this.user.email, this.user.password).then(function () {
	                ...
	                switch (responseError.status) {
	                    case 401:
	                        ...
	                        break;
	                    default:
	                        _this.error.message = "Login falhou";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-5567fbd8/Dashboard.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
